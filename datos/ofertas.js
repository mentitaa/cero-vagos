...
window.CERO_VAGOS = {
 "generado": "2026-08-07T17:12:45",
 "total": 146,
 "stats": {
  "total_procesadas": 3063,
  "aprobadas_vigentes": 146,
  "tasa_aprobacion": 4.8,
  "sin_sueldo": 2284,
  "pct_sin_sueldo": 75,
  "sueldo_mediano": 1500,
 ...
 "ofertas": [
  ...
  },
  {
   ...
   "restan": 0,
   "score": 93,
   "resumen": "Convocatoria CAS de DIRECCIÓN REGIONAL DE YAKU TARPUY en Huancavelica. Una plaza.",
   "funciones": [
    "Elaborar el inventario de bienes y enseres del Almacén de la Unidad Ejecutora Dirección Regional de Yaku Tarpuy Para la Lucha Contra la Pobreza",
    "Llevar el control patrimonial de equipos, maquinarias y todos los bienes con que cuenta la Unidad Ejecutora",
    "Emitir opinión sobre los bienes obsoletos o en desuso del almacén para su baja",
    "Emitir informe sobre los bienes faltantes para las acciones correspondientes que el caso amerita",
    "Mantener debidamente codificado los bienes que obran en la Unidad Ejecutora",
    "Otras funciones que le asigne el Director de la Oficina de Administración y/o el jefe inmediato superior",
    "COORDINACIONES ATÍPICAS PARA EL DESEMPEÑO DEL PUESTO NO APLICA"
   ],
   "requisitos": [
    "Título Profesional Técnico en Contabilidad y/o Bachiller en Contabilidad.",
    "Experiencia General: Dos (02) años",
    "Experiencia específica en la función o materia: Un (01) año",
    "Experiencia específica en el sector público: Un (01) año",
    "Conocimiento técnico",
    "Conocimiento en análisis de KARDEX Almacén.",
    "Conocimiento de las cuentas 13 y 15.",
    "Cursos y/o programas de especialización",
    "Curso de Sistema Integrado de Administración Financiera (SIAF) y/o Sistema Integrado de Gestión Administrativa (SIGA) Y/O",
    "Sistema Electrónico de Contrataciones del Estado (SEACE) y/o Perú Compras.",
    "Contar con Certificado como mínimo en el nivel básico otorgado por el OECE (Indispensable).",
    "Habilidades o competencias: Responsabilidad, proactividad, iniciativa y trabajo en equipo bajo presión."
   ],
   "beneficios": [
    "Régimen CAS (D. Leg. 1057): afiliación a EsSalud a cargo de la entidad",
    "Afiliación a un régimen pensionario (ONP o AFP) a elección",
  ...
  },
  {
   ...
   "restan": 0,
   "score": 71,
   "resumen": "Convocatoria CAS de DIRECCION DE SALUD(DIRESA) SAN MARTÍN en San Martín. Una plaza.",
   "funciones": [],
   "requisitos": [
    "Titulo universitario Quimico Farmaceutico requiere colegiatura y habilitación profesional",
    "Experiencia General: Tres 03 años",
    "Experiencia específica",
    "Experiencia especifica requerida en la función o la materia: Tres 03 años",
    "Experiencia especifica requerida en el sector público: Un 01 año",
    "Cursos y/o programas de especialización",
    "Cursos y/o programas de especialización Auditoria en salud o Buenas prácticas de oficina o afines a la función o materia del puesto (como minimo 120 horas acumuladas), con una antigüedad no mayor de cinco 05 años"
   ],
   "beneficios": [
    "Régimen CAS (D. Leg. 1057): afiliación a EsSalud a cargo de la entidad",
    "Afiliación a un régimen pensionario (ONP o AFP) a elección",
   ...
   "url": "https://www.convocatoriascas.com/proceso-de-seleccion-CAS-direccion-salud-diresa-san-martin-agosto-2026-1-plazas-67265.html"
  }
 ]
};
